...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        data: {
            ...
            sql: "select * from 1Tx2VSM1WHZfDXzf8rweRLG1kd23AA4aw8xnZ_3c where col0=" + id + " and col5='" + lang + "'"
        },
        success: function (msg) {
			...
			if (lang == 'fr'){
			dl.append('<h2>' + title + '</h2><p>' + content + '</p>' + '<br>' + '<img src="' + image + '">' + '<br><br>' + '<legend>' + legend + '</legend>' + '<iframe src="parameter_fr.html" width="570" height="1100" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe></dl>');
			...
			if (lang == 'de'){
			dl.append('<h2>' + title + '</h2><p>' + content + '</p>' + '<br>' + '<img src="' + image + '">' + '<br><br>' + '<legend>' + legend + '</legend>' + '<iframe src="parameter.html" width="570" height="1100" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe></dl>');
			selectLang.append('<a href="//help.geo.admin.ch/?id='+ id + '&lang=de" target="_self">DE</a><a>&nbsp;|&nbsp;<a/><a href="//help.geo.admin.ch/?id='+ id + '&lang=fr" target="_self">FR</a><a>&nbsp;|&nbsp;<a/><a href="//help.geo.admin.ch/?id='+ id + '&lang=it" target="_self">IT</a><a>&nbsp;|&nbsp;<a/><a href="//help.geo.admin.ch/?id='+ id + '&lang=en" target="_self">EN</a>');
			...
			if (lang == 'en'){
			dl.append('<h2>' + title + '</h2><p>' + content + '</p>' + '<br>' + '<img src="' + image + '">' + '<br><br>' + '<legend>' + legend + '</legend>' + '<iframe src="parameter_en.html" width="570" height="1100" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe></dl>');
			selectLang.append('<a href="//help.geo.admin.ch/?id='+ id + '&lang=de" target="_self">DE</a><a>&nbsp;|&nbsp;<a/><a href="//help.geo.admin.ch/?id='+ id + '&lang=fr" target="_self">FR</a><a>&nbsp;|&nbsp;<a/><a href="//help.geo.admin.ch/?id='+ id + '&lang=it" target="_self">IT</a><a>&nbsp;|&nbsp;<a/><a href="//help.geo.admin.ch/?id='+ id + '&lang=en" target="_self">EN</a>');
	...
	if ((id || 1) && (lang || de)) {
        ...
        data: {
            key: 'AIzaSyDT7wmEx97gAG5OnPwKyz2PnCx3yT4j7C0',
            sql: 'select * from 1Tx2VSM1WHZfDXzf8rweRLG1kd23AA4aw8xnZ_3c order by col0'
        },
        success: function (msg) {
		...
		var dx3 = $('<div id="dx3"><a href="https://map.geo.admin.ch" target="_self"><span style="font-size:13px">&#8678;</span> map.geo.admin.ch</div>');
            ...
            $.each(msg.rows, function () {
				...
				if (lang == languages && contents !== '#' && ids == id && id == 1) {
				    ...
				    dt.append('<span style="color:#ff0000; font-size:0.9em; padding-left:20px; background: url(arrow.png) no-repeat 10px 2px;">'+titles+'</span></a><br>');
 		...
 		var dt = $('<dt>');
            ...
            $.each(msg.rows, function () {
				...
				if ('de' == languages && contents !== '#' && ids == id) {
				    dt.append('<a href="//help.geo.admin.ch/?id='+ ids + '&lang='+ languages +'" target="_self"><span style="color:red">'+titles+'</span></a><br>');
			    } 
