                        ...
                        if (!olSource) {
                            ...
                            function getLayerFromCapabilitiesResponse(layer, capabilities_obj) {
                                ...
                                if (layer_capabilities.TileMatrixSetLink && layer_capabilities.TileMatrixSetLink.length > 0) {
                                    var tile_matrix_set = layer_capabilities.TileMatrixSetLink[0].TileMatrixSet;
                                    for (var i = 0; i < capabilities_obj.Contents.TileMatrixSet.length; i++) {
                                        if (capabilities_obj.Contents.TileMatrixSet[i].Identifier == tile_matrix_set) {
                                            layer_capabilities.TileMatrixSet = capabilities_obj.Contents.TileMatrixSet[i];
                                        }
                                    }
                                }
                            ...
                            if (capabilities_obj && capabilities_obj[layer.wmsUrl]) {
                                ...
                                var options = ol.source.WMTS.optionsFromCapabilities(capabilities_obj, {
                                    ...
                                    matrixSet: layer_capabilities.TileMatrixSetLink[0].TileMatrixSet,
                                    crossOrigin: crossOrigin
                                });
